...
export class MenuService {
  ...
  private chicken_05 = new MenuDetailModel('Chicken Cashewnuts', 'http://www.davidchuschinabistro.com/images/C5.jpg', 10.95, 14.95, 'C5', 'diced chicken with waterchestnuts, green peppers, and celery, and cashewnuts; white meat by request: for pint $1 extra, for large $2 extra');
  private chicken_06 = new MenuDetailModel('White Meat Chicken with Fresh Vegetables', 'http://www.davidchuschinabistro.com/images/C6.jpg', 10.95, 14.95, 'C6', 'white meat chicken in a clear white sauce sauteed with mixed vegetables');
  private chicken_07 = new MenuDetailModel('Sesame Chicken', 'http://www.davidchuschinabistro.com/images/C7.jpg', 10.95, 14.95, 'C7', 'chunks of chicken, breaded and deep-fried with a sesame seed sauce');
  private chicken_08 = new MenuDetailModel('Hunan Chicken ', 'http://www.davidchuschinabistro.com/images/C8.jpg', 10.95, 14.95, 'C8', 'white meat chicken sauteed with broccoli, mushrooms, and baby corn in Hunan sauce');
  private chicken_09 = new MenuDetailModel('Szechuan Chicken', 'http://www.davidchuschinabistro.com/images/C9.jpg', 10.95, 12.25, 'C9', 'white meat chicken sauteed with carrots, celery, and bean sprouts in Szechuan sauce');
  private chicken_10 = new MenuDetailModel('Kung Pao Chicken', 'http://www.davidchuschinabistro.com/images/C10.jpg', 10.95, 14.95, 'C10', 'diced chicken sauteed with peanuts, and celery in delicious kung pao sauce; white meat by request: for pint $1 extra, for large $2 extra');
